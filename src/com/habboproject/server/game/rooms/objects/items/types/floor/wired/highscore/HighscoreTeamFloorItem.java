 ...
 */
public class HighscoreTeamFloorItem extends RoomItemFloor {
    ...
    public HighscoreTeamFloorItem(long id, int itemId, Room room, int owner, int groupId, int x, int y, double z, int rotation, String data) {
        ...
        if (data.startsWith("1{") || data.startsWith("0{")) {
            ...
            this.itemData = new TeamScoreboardData(0, clearType, Maps.newHashMap());
    ...
    public void compose(IComposer msg, boolean isNew) {
        ...
        Collections.sort(entries, HighscoreTeamFloorItem.comparator);
