...
public class WiredTriggerWalksOnFurni extends WiredTriggerItem {
    public WiredTriggerWalksOnFurni(long id, int itemId, Room room, int owner, int groupId, int x, int y, double z, int rotation, String data) {
    ...
    public static boolean executeTriggers(RoomEntity entity, RoomItemFloor floorItem) {
        ...
        for (RoomItemFloor wiredItem : entity.getRoom().getItems().getByClass(WiredTriggerWalksOnFurni.class)) {
