 ...
 */
public class PositiveConditionStuffIsExecuteEvent implements Callable<Boolean> {
    private final WiredConditionItem conditionItem;
    private final List<Long> selectedItems;
    private final RoomEntity entity;
    private final Object data;

    public PositiveConditionStuffIsExecuteEvent(WiredConditionItem conditionItem, List<Long> selectedItems, RoomEntity entity, Object data) {
