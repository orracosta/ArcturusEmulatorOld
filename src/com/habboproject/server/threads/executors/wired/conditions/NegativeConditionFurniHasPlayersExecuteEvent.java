 ...
 */
public class NegativeConditionFurniHasPlayersExecuteEvent implements Callable<Boolean> {
    private final WiredConditionItem conditionItem;
    private final List<Long> selectedItems;

    public NegativeConditionFurniHasPlayersExecuteEvent(WiredConditionItem conditionItem, List<Long> selectedItems) {
