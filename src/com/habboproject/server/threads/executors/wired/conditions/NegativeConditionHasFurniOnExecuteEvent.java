 ...
 */
public class NegativeConditionHasFurniOnExecuteEvent implements Callable<Boolean> {
    private final static int PARAM_MODE = 0;

    private final WiredConditionItem conditionItem;
    private final List<Long> selectedItems;

    public NegativeConditionHasFurniOnExecuteEvent(WiredConditionItem conditionItem, List<Long> selectedItems) {
