 ...
 */
public class NegativeConditionMatchSnapshotExecuteEvent implements Callable<Boolean> {
    ...
    public NegativeConditionMatchSnapshotExecuteEvent(WiredConditionItem conditionItem, List<Long> selectedItems) {
