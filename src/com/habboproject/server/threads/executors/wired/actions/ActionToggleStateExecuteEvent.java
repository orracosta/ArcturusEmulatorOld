 ...
 */
public class ActionToggleStateExecuteEvent implements CometThread {
    private final WiredActionItem actionItem;
    private final List<Long> selectedItems;

    public ActionToggleStateExecuteEvent(WiredActionItem actionItem, List<Long> selectedItems) {
