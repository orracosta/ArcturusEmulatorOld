 ...
 * <p/>
 * Tasks submitted will be execute in the given {@link Executor}.
 ...
 */
public class ThreadOrderedExecutor<K> {

    private final Executor executor;
    private final Map<K, Task> tasks;

    /**
     * Constructs a {@code ThreadOrderedExecutor}.
     *
     * @param executor tasks will be execute in this executor.
     */
    public ThreadOrderedExecutor(Executor executor) {
        this.executor = executor;
        this.tasks = new HashMap<K, Task>();
    }

    /**
     * Adds a new task to execute for the given key.
     *
