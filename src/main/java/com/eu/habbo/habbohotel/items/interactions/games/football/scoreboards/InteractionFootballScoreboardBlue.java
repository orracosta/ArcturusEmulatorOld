...
public class InteractionFootballScoreboardBlue extends InteractionFootballScoreboard
{
    public InteractionFootballScoreboardBlue(ResultSet set, Item baseItem) throws SQLException
    {
