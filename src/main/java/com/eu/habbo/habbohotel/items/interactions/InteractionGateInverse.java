...
public class InteractionGateInverse extends HabboItem
{
    public InteractionGateInverse(ResultSet set, Item baseItem) throws SQLException
    {
        super(set, baseItem);
    }

    public InteractionGateInverse(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells)
    {
