...
public class GuildForumComment implements ISerialize, Runnable {
    ...
    public GuildForumComment(final ResultSet set, final int index, int guildId) throws SQLException {
    ...
    public void serialize(ServerMessage message) {
        message.appendInt(this.index);               //_local_2.messageId = k._SafeStr_5878();       = message_id
        ...
        message.appendInt(this.getAuthorPostCount());  //_local_2._SafeStr_11320 = k._SafeStr_5878();  = author_post_count
    }
