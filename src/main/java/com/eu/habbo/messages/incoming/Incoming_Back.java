...
public class Incoming_Back
{
   ...
   /* public static final int RequestInventoryItemsEvent = 372; // 1223
    ...
    public static final int RequestRoomUserTagsEvent = 3430;
    ...
    public static final int RequestDeleteRoomEvent = 3071;
    public static final int RequestPromotionRoomsEvent = 2730;
    public static final int BuyRoomPromotionEvent = 2363;


    public static final int RequestGuideToolEvent = 3003;
    public static final int RequestGuideAssistanceEvent = 2158;
    public static final int GuideUserTypingEvent = 705;
    public static final int GuideReportHelperEvent = 393;
    public static final int GuideRecommendHelperEvent = 151;
    public static final int GuideUserMessageEvent = 721;
    public static final int GuideCancelHelpRequestEvent = 1166;
    public static final int GuideHandleHelpRequestEvent = 459;
    public static final int GuideVisitUserEvent = 2776;
    public static final int GuideInviteUserEvent = 409;
    public static final int GuideCloseHelpRequestEvent = 2751;

    public static final int GuardianNoUpdatesWantedEvent = 1929;
    public static final int GuardianVoteEvent = 1371;
    public static final int GuardianAcceptRequestEvent = 1278;

    public static final int RequestGameConfigurationsEvent = 2994;
    public static final int RequestAchievementConfigurationEvent = 3160;

    public static final int RequestReportUserBullyingEvent = 62;
    public static final int ReportBullyEvent = 3061;

    public static final int CameraParserShit = 3800;
    public static final int SavePostItStickyPoleEvent = 2637;

    public static final int HotelViewClaimBadgeEvent = 1298;
    public static final int HotelViewRequestCommunityGoalEvent = 1204;
    public static final int HotelViewRequestConcurrentUsersEvent = 3489;
    public static final int HotelViewConcurrentUsersButtonEvent = 984;

    public static final int IgnoreRoomUserEvent = 3546;
    public static final int UnIgnoreRoomUserEvent = 3909;
    public static final int UnbanRoomUserEvent = 2374;

    public static final int RequestNavigatorSettingsEvent = 3202;
    public static final int SaveWindowSettingsEvent = 2276;
}
