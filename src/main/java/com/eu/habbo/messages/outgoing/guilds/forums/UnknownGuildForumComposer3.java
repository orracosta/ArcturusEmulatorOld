...
public class UnknownGuildForumComposer3 extends MessageComposer
{
    public final int guildId;
    public final int threadId;
    public final GuildForumComment comment;

    public UnknownGuildForumComposer3(int guildId, int threadId, GuildForumComment comment)
    {
    ...
    {
        this.response.init(Outgoing.UnknownGuildForumComposer3);
