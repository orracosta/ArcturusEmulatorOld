...
public class Outgoing_1006
{
   ...
   /* public static final int GenericAlertComposer = 1548;
    ...
    public final static int CantScratchPetNotOldComposer = 118; //:test 118 i:1 i:2
    ...
    public final static int SimpleRoomPollStartComposer = 3047; //:test 3047 s:a i:10 i:20 i:10000 i:1 i:1 i:3 s:abcdefghijklmnopqrstuvwxyz12345678901234? i:1 s:a s:b
    ...
    public final static int UserIgnoredComposer = 3858; //:test 3858 i:1 s:a     1/2 ignore. 3 unignore s:Username
    ...
    public final static int BullyReportHandled = 3401; //:test 3401 i:0
    public final static int PromoteRoomsComposer = 3376; //:test 3376 b:1 i:1 i:1 s:derp b:1 //NOT SURE
    public final static int NotEnoughPointsTypeComposer = 334; //:test 334 b:0 b:1 i:150
    ...
    public final static int GameAchievementsComposer = 2937;
    ...
    public final static int NewNavigatorDimensionsComposer = 2617; //:test 2617 i:10 i:10 i:2 i:0 b:0 i:10
    ...
    public final static int HelperRequestFailedComposer = 1917; //:test 1917 i:1 i:1 i:1 b:1 s:a s:b s:c
    ...
    public final static int BullyReportMessageComposer = 1858; //:test 1858 i:0
    ...
    public final static int CommunityGoalComposer = 1579; //:test 1579 b:1 i:0 i:1 i:2 i:3 i:4 i:5 s:a i:6 i:1 i:1
